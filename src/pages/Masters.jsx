    ...
    <div>
          ...
          {showUserForm && (
            <div style={{background:"white",borderRadius:12,padding:20,boxShadow:"0 1px 3px rgba(0,0,0,.06)",border:"1px solid #f1f5f9",marginBottom:16}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 12px"}}>
                {[["Full Name","name","text","e.g. Rahul Sharma"],["Email","email","email","e.g. rahul@ampleleap.com"],["Password","password","password","Min 6 characters"]].map(([l,k,t,p])=>(
      ...
      {!isStatusCodes && !isUsers && (
        <div style={{background:"white",borderRadius:12,padding:20,boxShadow:"0 1px 3px rgba(0,0,0,.06)",border:"1px solid #f1f5f9",maxWidth:560}}>
          <div style={{marginBottom:10,padding:"8px 12px",background:"#f0f9ff",borderRadius:8,fontSize:12,color:"#0369a1",border:"1px solid #bae6fd"}}>
            💡 These values appear in candidate form dropdowns. Add all options your team uses.
          </div>
